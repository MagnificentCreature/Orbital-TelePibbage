...
sendMessage('"Obama Dressing Up As Washington"')
sendMessage("Was Picked By: @JoeBiden @DonaldTrump")
sendMessage("This was a LIE by @HoXuWen")
sendMessage("@HoXuWen gains +300 points!")
